...
lambda_k_name = lambda k: random.choice(last_name).join(random.choice(first_name) for _ in range(k-1))
lambda_phone = lambda k: '010-'+str(lambda_number(k))+'-'+str(lambda_number(k))
lambda_birth = lambda startyear, endyear: str(random_number(startyear, endyear)) + '-' + str(random_number(1, 12))\
                                          + '-' + str(random_number(1, 32))

address_list = ["서울", "경기", "부산", "대구", "광주"]
job_list = ["회사원", "사업가", "개발자", "자영업자"]
interests_list = ["영화", "주식", "부동산", "독서"]

last_name = ["김", "이", "박", "최", "정", "강", "조", "윤", "장", "임", "한", "오", "서", "신", "권", "황", "안","송", "류",
              ...
              "어", "은", "편", "구", "용"]
first_name = ["가", "강", "건", "경", "고", "관", "광", "구", "규", "근", "기", "길", "나", "남", "노", "누", "다", "단", "달",
