...
crime_menu = {
    ...
    "8" : lambda t: t.which_cty_in_suv_compact(),
    "9" : lambda t: t.find_top5_hwy_in_audi(),
    "10" : lambda t: t.find_top3_avg(),
}
...
class CrimeService:
    ...
    1.스펙보기 
    id = SERIALNO  
    Index(['관서명', '살인 발생', '살인 검거', '강도 발생', '강도 검거', '강간 발생', 
    ...
    def save_police_pos(self):  #
        ...
        gmaps = (lambda x: googlemaps.Client(key=x))("### 키 입력 해야 댐 ###")
